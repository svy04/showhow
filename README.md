...
- **제목까지 대신 씁니다.** 바뀐 자리의 글자를 읽어 「다음 누르기」처럼 제목 후보를 채웁니다. 읽는 일도 이 컴퓨터 안에서 합니다.
- **검사 290건이 통과한 상태로 배포합니다.** 그중 187건은 진짜 브라우저에서, 10건은 진짜 화면 공유로 돌립니다.
...
통과    검사_제목.mjs           15건    3.7초   단계 글 자동 작성 — 화면 글자 읽기
